...
public class TabTechnical extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*toolbar.setTitle(R.string.title_tecnicos);*/

        firebaseEbook.read(view.getContext(), "Carregando...", Genre.TÉCNICO);
        ebookList = firebaseEbook.getEbookList();
        rvEbooks = view.findViewById(R.id.list_technician_ebooks);
